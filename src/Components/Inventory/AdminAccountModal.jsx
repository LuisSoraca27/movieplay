...
import { X, Check, Store, DollarSign, Mail, Lock, Key, Calendar } from 'lucide-react';

const AdminAccountModal = ({ visible, onHide, onSubmit, initialData }) => {
    ...
    const handleFormSubmit = async (data) => {
        ...
        try {
            const submissionData = {
                ...
                creation_date: data.creation_date ? data.creation_date.toISOString() : null,
            ...
            <ModalContent>
                <ModalHeader className="flex flex-col gap-1">
                    ...
                    <span className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">
                        {isEditMode ? "MODIFICAR DATOS DEL ADMINISTRADOR" : "REGISTRAR CREDENCIALES ADMINISTRATIVAS"}
                    </span>
                </ModalHeader>
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="flex flex-col gap-5">
                            <h3 className="text-xs font-bold text-slate-900 uppercase tracking-widest flex items-center gap-2 mb-2">
                                <Store size={14} className="text-indigo-500" /> Información Proveedor
                            </h3>
                            ...
                            <h3 className="text-xs font-bold text-slate-900 uppercase tracking-widest flex items-center gap-2 mb-2">
                                <Key size={14} className="text-indigo-500" /> Credenciales
                            </h3>
                        ...
                        <div className="flex flex-col gap-5">
                            <h3 className="text-xs font-bold text-slate-900 uppercase tracking-widest flex items-center gap-2 mb-2">
                                <Calendar size={14} className="text-indigo-500" /> Vigencia y Estado
                            </h3>
                            ...
                            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-2">Perfiles Pre-configurados</h3>
