...
function RegisterOrderByCombo({ show, onClose, product }) {
  ...
  const onSubmit = (formDataVal) => {
    ...
    dispatch(createOrderInternal(formData)).then((res) => {
      if (res?.error) {
        setCurrentStep(1);
      } else {
        reset();
                ...
                {currentStep === 0 && (
                  ...
                  >
                    ...
                    <div className="w-full md:w-7/12 flex flex-col gap-4">
                      ...
                      <div className="bg-blue-50/50 dark:bg-blue-900/10 p-4 rounded-2xl border border-blue-100 dark:border-blue-800/30 mt-2">
                        <p className="text-xs font-bold text-blue-400 uppercase tracking-widest mb-1">Precio</p>
